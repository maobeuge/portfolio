...
class FollowMySportWorkflow extends StatelessWidget {
  const FollowMySportWorkflow({super.key});
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const WorkflowPhoneDisplay(phoneDisplays: [
                        "assets/fms.jpg",
                        "assets/fms_map.png",
                        "assets/fms_search.png",
                        "assets/fms_profile.png"
                      ]),
                    ],
                  ),
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: getDescription(
                                  state.texts["workflowFMSDescription"],
                                  context),
                            ),
                          ),
                        ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          state.texts["workflowFMSFeaturesGeo"],
                                          style: Theme.of(context)
                                              .textTheme
                                              .labelMedium!
