...
class AltermobiliteWorkflow extends StatelessWidget {
  const AltermobiliteWorkflow({super.key});
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const WorkflowPhoneDisplay(
                          phoneDisplays: ["assets/altermobilité.png"]),
                    ],
                  ),
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: getDescription(
                                  state.texts["workflowAMDescription"],
                                  context),
                            ),
                          ),
                        ),
