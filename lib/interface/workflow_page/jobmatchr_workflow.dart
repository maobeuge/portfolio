...
class JobmatchrWorkflow extends StatelessWidget {
  const JobmatchrWorkflow({super.key});
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: getDescription(
                                  state.texts["workflowJMRDescription"],
                                  context),
                            ),
                          ),
                        ),
